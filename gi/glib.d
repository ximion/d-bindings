...
__gshared extern(C)
{
	...
	int g_bookmark_file_load_from_data_dirs (GBookmarkFile* bookmark, const(char)* file, char** fullPath, GError** err);
	int g_bookmark_file_load_from_file (GBookmarkFile* bookmark, const(char)* filename, GError** err);
	...
	int g_bookmark_file_to_file (GBookmarkFile* bookmark, const(char)* filename, GError** err);
	...
	GIOChannel* g_io_channel_new_file (const(char)* filename, const(char)* mode, GError** err);
	...
	void g_key_file_set_locale_string (GKeyFile* keyFile, const(char)* groupName, const(char)* key, const(char)* locale, const(char)* str);
	...
	void g_key_file_set_string (GKeyFile* keyFile, const(char)* groupName, const(char)* key, const(char)* str);
	...
	void g_main_context_invoke (GMainContext* context, GSourceFunc funct, void* data);
	void g_main_context_invoke_full (GMainContext* context, int priority, GSourceFunc funct, void* data, GDestroyNotify notify);
	...
	GMappedFile* g_mapped_file_new (const(char)* filename, int writable, GError** err);
	...
	int g_pattern_match (GPatternSpec* pspec, uint stringLength, const(char)* str, const(char)* stringReversed);
	int g_pattern_match_simple (const(char)* pattern, const(char)* str);
	int g_pattern_match_string (GPatternSpec* pspec, const(char)* str);
	...
	int g_regex_match (GRegex* regex, const(char)* str, GRegexMatchFlags matchOptions, GMatchInfo** matchInfo);
	int g_regex_match_all (GRegex* regex, const(char)* str, GRegexMatchFlags matchOptions, GMatchInfo** matchInfo);
	int g_regex_match_all_full (GRegex* regex, char* str, ptrdiff_t stringLen, int startPosition, GRegexMatchFlags matchOptions, GMatchInfo** matchInfo, GError** err);
	int g_regex_match_full (GRegex* regex, char* str, ptrdiff_t stringLen, int startPosition, GRegexMatchFlags matchOptions, GMatchInfo** matchInfo, GError** err);
	GRegex* g_regex_ref (GRegex* regex);
	char* g_regex_replace (GRegex* regex, char* str, ptrdiff_t stringLen, int startPosition, const(char)* replacement, GRegexMatchFlags matchOptions, GError** err);
	char* g_regex_replace_eval (GRegex* regex, char* str, ptrdiff_t stringLen, int startPosition, GRegexMatchFlags matchOptions, GRegexEvalCallback eval, void* userData, GError** err);
	char* g_regex_replace_literal (GRegex* regex, char* str, ptrdiff_t stringLen, int startPosition, const(char)* replacement, GRegexMatchFlags matchOptions, GError** err);
	char** g_regex_split (GRegex* regex, const(char)* str, GRegexMatchFlags matchOptions);
	char** g_regex_split_full (GRegex* regex, char* str, ptrdiff_t stringLen, int startPosition, GRegexMatchFlags matchOptions, int maxTokens, GError** err);
	void g_regex_unref (GRegex* regex);
	int g_regex_check_replacement (const(char)* replacement, int* hasReferences, GError** err);
	GQuark g_regex_error_quark ();
	char* g_regex_escape_nul (const(char)* str, int length);
	char* g_regex_escape_string (char* str, int length);
	int g_regex_match_simple (const(char)* pattern, const(char)* str, GRegexCompileFlags compileOptions, GRegexMatchFlags matchOptions);
	char** g_regex_split_simple (const(char)* pattern, const(char)* str, GRegexCompileFlags compileOptions, GRegexMatchFlags matchOptions);
	...
	GString* g_string_append (GString* str, const(char)* val);
	GString* g_string_append_c (GString* str, char c);
	GString* g_string_append_len (GString* str, const(char)* val, ptrdiff_t len);
	void g_string_append_printf (GString* str, const(char)* format, ... );
	GString* g_string_append_unichar (GString* str, dchar wc);
	GString* g_string_append_uri_escaped (GString* str, const(char)* unescaped, const(char)* reservedCharsAllowed, int allowUtf8);
	void g_string_append_vprintf (GString* str, const(char)* format, void* args);
	GString* g_string_ascii_down (GString* str);
	GString* g_string_ascii_up (GString* str);
	GString* g_string_assign (GString* str, const(char)* rval);
	GString* g_string_down (GString* str);
	int g_string_equal (GString* v, GString* v2);
	GString* g_string_erase (GString* str, ptrdiff_t pos, ptrdiff_t len);
	char* g_string_free (GString* str, int freeSegment);
	GBytes* g_string_free_to_bytes (GString* str);
	uint g_string_hash (GString* str);
	GString* g_string_insert (GString* str, ptrdiff_t pos, const(char)* val);
	GString* g_string_insert_c (GString* str, ptrdiff_t pos, char c);
	GString* g_string_insert_len (GString* str, ptrdiff_t pos, const(char)* val, ptrdiff_t len);
	GString* g_string_insert_unichar (GString* str, ptrdiff_t pos, dchar wc);
	GString* g_string_overwrite (GString* str, size_t pos, const(char)* val);
	GString* g_string_overwrite_len (GString* str, size_t pos, const(char)* val, ptrdiff_t len);
	GString* g_string_prepend (GString* str, const(char)* val);
	GString* g_string_prepend_c (GString* str, char c);
	GString* g_string_prepend_len (GString* str, const(char)* val, ptrdiff_t len);
	GString* g_string_prepend_unichar (GString* str, dchar wc);
	void g_string_printf (GString* str, const(char)* format, ... );
	GString* g_string_set_size (GString* str, size_t len);
	GString* g_string_truncate (GString* str, size_t len);
	GString* g_string_up (GString* str);
	void g_string_vprintf (GString* str, const(char)* format, void* args);
	...
	char* g_string_chunk_insert (GStringChunk* chunk, const(char)* str);
	char* g_string_chunk_insert_const (GStringChunk* chunk, const(char)* str);
	char* g_string_chunk_insert_len (GStringChunk* chunk, const(char)* str, ptrdiff_t len);
	...
	GVariant* g_variant_new_bytestring (char* str);
	...
	GVariant* g_variant_new_take_string (char* str);
	...
	GString* g_variant_print_string (GVariant* value, GString* str, int typeAnnotate);
	GVariant* g_variant_ref (GVariant* value);
	GVariant* g_variant_ref_sink (GVariant* value);
	void g_variant_store (GVariant* value, void* data);
	GVariant* g_variant_take_ref (GVariant* value);
	void g_variant_unref (GVariant* value);
	int g_variant_is_object_path (const(char)* str);
	int g_variant_is_signature (const(char)* str);
	...
	int g_variant_type_string_scan (const(char)* str, const(char)* limit, char** endptr);

	// glib.Module

	int g_module_close (GModule* modul);
	void g_module_make_resident (GModule* modul);
	const(char)* g_module_name (GModule* modul);
	int g_module_symbol (GModule* modul, const(char)* symbolName, void** symbol);
	...
	size_t g_base64_decode_step (char* inn, size_t len, char* output, int* state, uint* save);
	...
	size_t g_base64_encode_close (int breakLines, char* output, int* state, int* save);
	size_t g_base64_encode_step (char* inn, size_t len, int breakLines, char* output, int* state, int* save);

	// glib.Idle

	uint g_idle_add (GSourceFunc funct, void* data);
	uint g_idle_add_full (int priority, GSourceFunc funct, void* data, GDestroyNotify notify);
	...
	int g_spawn_async (const(char)* workingDirectory, char** argv, char** envp, GSpawnFlags flags, GSpawnChildSetupFunc childSetup, void* userData, GPid* childPid, GError** err);
	int g_spawn_async_with_pipes (const(char)* workingDirectory, char** argv, char** envp, GSpawnFlags flags, GSpawnChildSetupFunc childSetup, void* userData, GPid* childPid, int* standardInput, int* standardOutput, int* standardError, GError** err);
	...
	int g_spawn_sync (const(char)* workingDirectory, char** argv, char** envp, GSpawnFlags flags, GSpawnChildSetupFunc childSetup, void* userData, char** standardOutput, char** standardError, int* exitStatus, GError** err);
	...
	int g_snprintf (char* str, gulong n, char* format, ... );
	int g_sprintf (char* str, char* format, ... );
	...
	char** g_str_tokenize_and_fold (const(char)* str, const(char)* translitLocale, char*** asciiAlternates);
	char* g_strcanon (char* str, const(char)* validChars, char substitutor);
	...
	char* g_strdelimit (char* str, const(char)* delimiters, char newDelimiter);
	...
	char** g_strsplit (const(char)* str, const(char)* delimiter, int maxTokens);
	char** g_strsplit_set (const(char)* str, const(char)* delimiters, int maxTokens);
	char* g_strstr_len (const(char)* haystack, ptrdiff_t haystackLen, const(char)* needle);
	double g_strtod (const(char)* nptr, char** endptr);
	char* g_strup (char* str);
	GType g_strv_get_type ();
	uint g_strv_length (char** strArray);
	int g_strv_contains (const(char)* strv, const(char)* str);
	int g_vasprintf (char** str, char* format, void* args);
	int g_vfprintf (FILE* file, char* format, void* args);
	int g_vprintf (char* format, void* args);
	int g_vsnprintf (char* str, gulong n, char* format, void* args);
	int g_vsprintf (char* str, char* format, void* args);

	// glib.Timeout

	uint g_timeout_add (uint interval, GSourceFunc funct, void* data);
	uint g_timeout_add_full (int priority, uint interval, GSourceFunc funct, void* data, GDestroyNotify notify);
	uint g_timeout_add_seconds (uint interval, GSourceFunc funct, void* data);
	uint g_timeout_add_seconds_full (int priority, uint interval, GSourceFunc funct, void* data, GDestroyNotify notify);
	...
	uint g_parse_debug_string (const(char)* str, GDebugKey* keys, uint nkeys);
	char* g_path_get_basename (const(char)* fileName);
	char* g_path_get_dirname (const(char)* fileName);
	int g_path_is_absolute (const(char)* fileName);
	const(char)* g_path_skip_root (const(char)* fileName);
	...
	char* g_filename_to_utf8 (const(char)* opsysstring, ptrdiff_t len, size_t* bytesRead, size_t* bytesWritten, GError** err);
	...
	uint g_child_watch_add (GPid pid, GChildWatchFunc funct, void* data);
	uint g_child_watch_add_full (int priority, GPid pid, GChildWatchFunc funct, void* data, GDestroyNotify notify);
	...
	int g_access (const(char)* filename, int mode);
	...
	char* g_file_read_link (const(char)* filename, GError** err);
	int g_file_set_contents (char* filename, char* contents, ptrdiff_t length, GError** err);
	int g_file_test (const(char)* filename, GFileTest test);
	...
	int g_rmdir (const(char)* filename);
	int g_unlink (const(char)* filename);
	...
	const(char)* g_intern_static_string (const(char)* str);
	const(char)* g_intern_string (const(char)* str);
	GQuark g_quark_from_static_string (const(char)* str);
	GQuark g_quark_from_string (const(char)* str);
	const(char)* g_quark_to_string (GQuark quark);
	GQuark g_quark_try_string (const(char)* str);
	...
	uint g_unix_fd_add (int fd, GIOCondition condition, GUnixFDSourceFunc funct, void* userData);
	uint g_unix_fd_add_full (int priority, int fd, GIOCondition condition, GUnixFDSourceFunc funct, void* userData, GDestroyNotify notify);
	...
	char* g_filename_to_uri (const(char)* filename, const(char)* hostname, GError** err);

...
public class Socket : ObjectG, DatagramBasedIF, InitableIF
{
	...
	/** */
	public int receiveMessages(GInputMessage* messages, uint numMessages, int flags, Cancellable cancellable)
	{
		GError* err = null;
		
		auto p = g_socket_receive_messages(gSocket, messages, numMessages, flags, (cancellable is null) ? null : cancellable.getCancellableStruct(), &err);
